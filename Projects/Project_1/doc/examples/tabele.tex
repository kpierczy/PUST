\chapter{Tabele}
W~praktyce bardzo czêsto nale¿y wyrównaæ liczby wzglêdem cyfr znacz¹cych w~poszczególnych kolumnach (czyli przecinek dziesiêtny ma byæ we wszystkich wierszach tabeli umieszczony w~tym samym miejscu w~pionie). Do wyrównania liczb mo¿na wykorzystaæ pakiet \verb+siunitx+, co zastosowano w tab.~\ref{t_wyrownanie_do_znaku_przecinek3} (pakiety \verb+rccol+ oraz \verb+dcolumn+ maj¹ mniejsze mo¿liwoœci).
